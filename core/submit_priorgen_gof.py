...
with open('exec.sh','w') as o:
    for sim in locus_param_df:
        ...
        output_command += '}' + ' | python3 {binpath}/scrm_calc.py locus_datafile={locus_datafile} num_dataset={num_dataset} locus_write={locus_write} global_write={global_write}\n'.format(binpath=binpath,locus_datafile=locus_datafile,num_dataset=num_dataset,locus_write=locus_write,global_write=global_write) 
        num_dataset += 1
